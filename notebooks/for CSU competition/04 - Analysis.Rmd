...
df.train <- df[match(indices[1:(nrow(word_count_matrix)*0.8)], df$ID), ]
df.test <- df[match(indices[(nrow(word_count_matrix)*0.8+1):nrow(word_count_matrix)], df$ID), ]
