...
[comment]: # (* Words with a contraction should drop the contraction ("bitch'll" -> "bitch"))
...
unique_df_words <- df_words %>% distinct(Name, Artists, ID, word, .keep_all = TRUE)
...
```{r}
head(final_df)
final_df[final_df$Name == "Word Crimes",]
```
